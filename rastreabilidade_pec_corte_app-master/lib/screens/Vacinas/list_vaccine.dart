...
import 'package:rastreabilidade_pec_corte_app/widgets/list_item_vacina_view.dart';
import 'package:rastreabilidade_pec_corte_app/widgets/list_iten_rebanho_view.dart';


class ListVaccine extends StatefulWidget {
  final User user;
  const ListVaccine({required this.user});

  @override
  ListVaccineState createState() => ListVaccineState();
}

class ListVaccineState extends State<ListVaccine> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: StreamBuilder<QuerySnapshot>(
            stream: db.collection('vacina').snapshots(),
